...
export class ProgramService {
    ...
    getProgramList(id,getBy) {
        return this.httpClient.get(
            this.commonService.envUrl() + 'api/program/all/'+getBy+'/'+id);
    }
    ...
    deleteProgramDetailsById(id) {
        return this.httpClient.delete(
            this.commonService.envUrl() + 'api/program/' + id);
    }
    saveProgram(programData) {
        return this.httpClient.post(
            this.commonService.envUrl() + 'api/program', 
            programData);
    }
    ...
    getShadeDetail() {
        return this.httpClient.get(
            this.commonService.envUrl() + 'api/program/PartyShadeDetailPartyWise');
    }
    getBatchDetailByQualityId(id) {
        return this.httpClient.get(
            this.commonService.envUrl() + 'api/program/BatchData/' + id);
    }
    getStockQualityList(id) {
        return this.httpClient.get(
            this.commonService.envUrl() + 'api/program/StockQuality/' + id);
    }
