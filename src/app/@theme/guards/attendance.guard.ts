...
import * as errorData from '../json/error.json';
...
export class AttndanceGuard implements CanActivate {
  ...
  canActivate(
    ...
    var permission = this.jwtToken.getDecodeToken('attendance');
   ...
   switch (PermissionName[0]) {
     ...
     case 'add':
       ...
       {this._router.navigate(['/pages/attendance']);
       return false;}
