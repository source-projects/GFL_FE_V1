...
export class EmployeeRegistrationGuard implements CanActivate {
  ...
  canActivate(
    ...
    var permission = this.jwtToken.getDecodeToken('employee');
   ...
   switch (PermissionName[0]) {
     ...
     case 'add':
       ...
       {this._router.navigate(['/pages/registration/view']);
       return false;}
