...
export class TaskComponent implements OnInit {
            ...
            .subscribe((data) => {
              if (data["data"] && data["data"].length > 0) {
                data["data"].forEach((element) => {
                  this.assignCardDetail.push(element);
                });
              }
            });
        });
  ...
  getAssignCardDetail() {
    ...
    console.log(this.assignCardDetail);
