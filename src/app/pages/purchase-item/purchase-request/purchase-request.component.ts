...
export class PurchaseRequestComponent implements OnInit {
  ...
  constructor(private toastr:ToastrService, private commonService:CommonService, private purchaseService: PurchaseService, private supplierService:SupplierService) { }
  ...
  makeRequest(myForm){
    ...
    if(myForm.valid){
      ...
      this.purchaseService.addPurchaseRequest(this.purchaseRequest).subscribe(
        data=>{
          if(data['success'])
            this.toastr.success('Item requested')
